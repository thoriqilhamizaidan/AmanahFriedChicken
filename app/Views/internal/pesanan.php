                ...
                <table class="table table-bordered" id="myTable">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($datapembelian as $b) : ?>
                            <?php if ($b['statusbeli'] === 'Pesanan Di Kirim' || $b['statusbeli'] === 'Selesai'|| $b['statusbeli'] === 'Sudah Upload Bukti Makanan') : ?> <tr>
                                    <th scope="row"><?= $i++ ?></th>
                                    <td><?= $b['nama'] ?></td>
                                    <td>
                                        <ul>
                                    ...
                                    <td>
                                        <?php if ($b['statusbeli'] != 'Belum Bayar') { ?>
                                            <a href="<?= base_url() ?>internal/pesanandetail/<?= $b['idbeli'] ?>" class="btn btn-info">Detail</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
