...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            <h1 class="mt-2">Laporan Pemesanan</h1>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <a href="<?= base_url('internal/laporanpemesanancetak/' . $tanggalawal . '/' . $tanggalakhir) ?>" target="_blank" class="btn btn-success" style="margin-top:30px">Download Laporan</a>
